...
var _user$project$Load$config = _evancz$elm_sortable_table$Table$config(
	{
		toId: function (_) {
			return _.city;
		},
		...
		case 'Grid':
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						ctor: '::',
						_0: A3(_evancz$elm_sortable_table$Table$view, _user$project$Load$config, model.tableState, model.employers),
						_1: {ctor: '[]'}
					}
				});
		case 'Edit':
