										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {employmentStatus: a, occupation: b, employer: c, startDate: d, endDate: e, contactPerson: f, status: g, addressLine1: h, addressLine2: i, city: j, state: k, zipCode: l, phone: m, email: n, comment: o};
														};
													};
												};
											};
